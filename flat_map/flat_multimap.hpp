...
class flat_multimap : private detail::_binary_flat_tree_base<flat_multimap<Key, T, Compare, Container>, Key, Compare, Container>
{
    using _super = typename flat_multimap::_binary_flat_tree_base;
