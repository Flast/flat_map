...
class flat_multiset : private detail::_binary_flat_tree_base<flat_multiset<Key, Compare, Container>, Key, Compare, Container>
{
    using _super = typename flat_multiset::_binary_flat_tree_base;
