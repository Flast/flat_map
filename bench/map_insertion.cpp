...
BENCHMARK_TEMPLATE(BM_insert_sorted, flat_map::flat_map<int, int>)->Range(4, 1 << 18);
BENCHMARK_TEMPLATE(BM_insert_sorted, flat_map::flat_map<int, int, std::less<int>, std::deque<std::pair<int, int>>>)->Range(4, 1 << 18);
